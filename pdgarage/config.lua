...
Config.PoliceVehicles = {
	{ model = 'chargnforce', label = 'LSPD Dodge Charger - Marked', price = 0 },
	{ model = 'pdcvpi', label = 'LSPD Corwn Vic - Marked', price = 0 },
	{ model = 'pdfpiu', label = 'LSPD Ford Explorer - Marked', price = 0 },
	{ model = 'pdimpala', label = 'LSPD Chevy Impala - Marked', price = 0 },
	{ model = 'tahoe', label = 'LSPD Chevy Tahoe - Marked', price = 0},
	{ model = 'swatsubrb', label = '2021 LSPD Suburban', price= 0},
	{ model = 'code3camero', label = 'Chiefs 2020 Camero', price = 0},
	{ model = 'socharger', label = 'SASP Dodge Charger - Marked', price = 0 },
	{ model = 'soexplorer', label = 'SASP Ford Explorer - Marked', price = 0 },
	{ model = 'sotaurus', label = 'SASP Ford Taurus - Marked', price = 0},
	{ model = 'sotruck', label = 'SASP Ford F150 - Marked', price = 0},
	{ model = 'code3durango', label = 'SASP Durango - MARKED', price = 0},
	{ model = 'jeeppol', label = 'SASP Jeep Wrangler Rubicon', price = 0},
	{ model = '909_21suburban', label = '2021 SASP Unmarked Suburban', price = 0},
	{ model = '18charger', label = 'BCSO Dodge Charger - Marked', price = 0},
	{ model = 'hptahoe', label = 'BCSO Chevy Tahoe - Marked', price = 0},
	{ model = 'sscvpi', label = 'BCSO Crown Vic - Marked', price = 0},
	{ model = 'code320exp', label = 'BCSO Explorer', price = 0},
	{ model = 'nm_z34', label = 'Unmarked 350z Pursuit Unit', price = 0},
	{ model = 'jtd19tundra', label = 'Unamrked Tundra', price = 0},
	{ model = 'fxtr34', label = 'Unmarked Nissan GTR R34', price = 0}
}

-- Police Helicopters:
Config.PoliceHelicopters = {
	{ model = 'pdheli', label = 'SASP Maverick', livery = 0, price = 0 },
	{ model = 'pdheli', label = 'LSPD Maverick', livery = 1, price = 0},
	{ model = 'pdheli', label = 'BCSO Maverick', livery = 3, price = 0}
}
